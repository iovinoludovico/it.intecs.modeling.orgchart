...
public class OrgchartAdapterFactory extends AdapterFactoryImpl {
	...
	protected OrgchartSwitch<Adapter> modelSwitch =
		new OrgchartSwitch<Adapter>() {
			...
			@Override
			public Adapter caseorgchartModel(orgchartModel object) {
				return createorgchartModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link orgchart.President <em>President</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link orgchart.Member <em>Member</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link orgchart.orgchartModel <em>orgchart Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createorgchartModelAdapter() {
		return null;
	}
