...
public class OrgchartSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OrgchartPackage.PRESIDENT: {
				President president = (President)theEObject;
				T result = casePresident(president);
				if (result == null) result = caseMember(president);
				if (result == null) result = caseNamedElement(president);
			...
			case OrgchartPackage.ORGCHART_MODEL: {
				orgchartModel orgchartModel = (orgchartModel)theEObject;
				T result = caseorgchartModel(orgchartModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>orgchart Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>orgchart Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseorgchartModel(orgchartModel object) {
		return null;
	}
