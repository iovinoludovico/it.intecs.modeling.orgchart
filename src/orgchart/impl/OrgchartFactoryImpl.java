...
public class OrgchartFactoryImpl extends EFactoryImpl implements OrgchartFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case OrgchartPackage.PRESIDENT: return createPresident();
			case OrgchartPackage.NAMED_ELEMENT: return createNamedElement();
			case OrgchartPackage.MEMBER: return createMember();
			case OrgchartPackage.ORGCHART_MODEL: return createorgchartModel();
			default:
	 ...
	 * @generated
	 */
	public orgchartModel createorgchartModel() {
		orgchartModelImpl orgchartModel = new orgchartModelImpl();
